...
%death function for class VACCINATED
%agt=vaccinated object
%cn - current agent number
%klld=1 if agent dies, =0 otherwise

%vaccinateds die if their food level reaches zero or they are older than max_age
...
%frequency parameters for both infected and vaccinated
