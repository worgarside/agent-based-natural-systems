...
spd=agt.speed;                       %vaccinated migration speed in units per iteration - this is equal to the food search radius
...
mig=0;                          %flag will be reset to one if vaccinated migrates
...
if mig==0                                   %vaccinated has been unable to find food, so chooses a random direction to move in      
    cnt=1;
    dir=rand*2*pi;              
    while mig==0&&cnt<=8                     
